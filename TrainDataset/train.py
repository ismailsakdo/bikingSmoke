...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 17 09:22:55 2023
...
df = pd.read_csv('/Users/ismailsa/DATASET/DeployML-BikingSmoke/TrainDataset/heart_data.csv')
print(df.head())
...
import pickle
pickle.dump(model, open('/Users/ismailsa/DATASET/DeployML-BikingSmoke/models/model.pkl','wb'))
